...
if(isset($_POST['btn-login'])){
  ...
  $data =  selectAll($conn,"SELECT * FROM `tbl_custumer` WHERE email='$name' and password='$password' ");
  ...
  if(!empty($data)){
    ...
    $err['error'] = "Tên tài khoản hoặc mật khẩu không chính xác";
  }
...
<body>
   <div class="login-container">
      <form method="POST" class="form-login">
         ...
         <input id="login-input-user" class="login__input" name="username" type="text" />
         ...
         <button type="submit" name="btn-login" class="login__submit">Sign in</button>
      </form>
